# Starter README (original)

> This is the **original starter README** shipped with the `://agent_arena`
> hackathon template, preserved verbatim for setup/run reference and attribution.
> Our harness front door lives in the root [`README.md`](../README.md); deeper docs
> are in [`ARCHITECTURE.md`](ARCHITECTURE.md) and [`METHODOLOGY.md`](METHODOLOGY.md).
